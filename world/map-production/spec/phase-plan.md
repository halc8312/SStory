...
`dev-r22`のstatusは`fresh-development-only`です。dev-r21の全200 artifact morphology、duplicate construction、tier、formal/development minima、metric、threshold、population、rateを変更しません。scheduleは`dev-r22-r21-morphology-strict-preseal-decision-schedule-v1`、fresh root / keyは`tmp/map-production/microtexture-v2-r6-dev-r22` / `tmp/map-production/microtexture-v2-r6-dev-r22/private/development-key.bin`です。public noncesは`r6-calibration-v17` / `r6-holdout-v17`、condition-cluster / render-seed / opaque-code / private-reference-transformはv17、public commitmentはv18、key commitment / foundation lanes / delta / private-control-idはv16です。protocol-zero / artifact basesは`1451000` / `1461000` / `1473000` / `1483000`、duplicate noncesは`1491000..1491002` / `1501000..1501002`です。generation以降は未開始です。
