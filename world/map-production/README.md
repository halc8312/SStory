...
fresh development-only `dev-r22`はdev-r21の全200アーティファクト形態、両duplicate、tier、minima、metric、threshold、population、rateを変更しません。scheduleは`dev-r22-r21-morphology-strict-preseal-decision-schedule-v1`です。root / keyは`tmp/map-production/microtexture-v2-r6-dev-r22` / `tmp/map-production/microtexture-v2-r6-dev-r22/private/development-key.bin`、public noncesは`r6-calibration-v17` / `r6-holdout-v17`です。condition-cluster / render-seed / opaque-code / private-reference-transformはv17、public commitmentはv18、key commitment / foundation lanes / delta / private-control-idはv16です。protocol-zero / アーティファクトbasesは`1451000` / `1461000` / `1473000` / `1483000`、duplicate noncesは`1491000..1491002` / `1501000..1501002`です。
